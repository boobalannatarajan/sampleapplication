...
public class Reminder {
	...
	public Reminder(String id, String string, String string1, String string2, String string3, Date date) {
		this.reminderId = id;
	...
	public String toString() {
		return "Reminder [reminderId=" + reminderId + ", reminderName=" + reminderName + ", reminderDescription="
				+ reminderDescription + ", reminderType=" + reminderType + ", reminderCreationDate="
				+ reminderCreationDate + ", reminderCreatedBy=" + reminderCreatedBy + "]";
	}
}